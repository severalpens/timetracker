...
export default function ComponentUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setChildren(
      typeof cleanValues.children === "string"
        ? cleanValues.children
        : JSON.stringify(cleanValues.children)
    );
    setErrors({});
  };
  const [componentRecord, setComponentRecord] = React.useState(component);
  React.useEffect(() => {
