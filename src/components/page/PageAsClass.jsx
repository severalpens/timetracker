...
export default class PageAsClass extends React.PureComponent {
  ...
  submitHandler = async (e) => {
    e.preventDefault();
    await this.mutationRequest(this.state.component, "create");
  }
  ...
  render() {
    return (
      <div className="flex">
        ...
        <Form mutationRequest={this.mutationRequest} handleChange={this.handleChange} submitHandler={this.submitHandler}></Form>
      </div>
    )
  }
}
